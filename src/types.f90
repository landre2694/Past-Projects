...
!!
!! Fundamental constants (i.e. pi;, e, hbar,...) may also be defined 
!! here if desired. This is a good place to define this type of 
!! constants as all modules and the main program will (in principle)
!! use this module
!---------------------------------------------------------------------
module types
